...
import { Search, ShoppingCart, Menu, X, Star, TrendingUp, Zap, Gift, Package, User, LogOut, ChevronDown, Rocket } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          ...
          <div className="flex items-center justify-between h-16 gap-3">
            ...
            <Link href="/" className="flex items-center gap-1.5 sm:gap-2 font-bold flex-shrink-0">
              ...
              <span className="text-lg sm:text-2xl bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent font-bold hidden sm:inline">OpnMart</span>
              <span className="text-lg sm:hidden bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent font-bold">OM</span>
            </Link>
            ...
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              >
                ...
                {getCartCount() > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 bg-green-500 text-black text-xs rounded-full h-5 w-5 flex items-center justify-center font-bold text-center leading-none">
                    {getCartCount()}
                  </span>
                )}
              </Link>
              ...
              {vendor || buyer ? (
                ...
                <div className="relative hidden sm:block" data-profile-menu>
                  ...
                  {/* Dropdown Menu */}
                  {showProfileMenu && (
                    <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-zinc-900 rounded-lg shadow-xl border border-green-500/30 z-50 overflow-hidden" data-profile-menu>
                      <button
                        onClick={(e) => {
                          handleProfileClick();
                        }}
                ...
                // Not Logged In - Auth Buttons (Hidden on small mobile)
                <div className="hidden sm:flex items-center gap-2">
                  <button
                    onClick={() => setShowLoginModal(true)}
                    className="px-2 sm:px-3 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all duration-300 text-green-600 dark:text-green-400 hover:bg-green-500/10 dark:hover:bg-green-500/20 border border-green-500/50 hover:border-green-500 hover:text-green-700 dark:hover:text-green-300"
                  >
                    Sign In
                  </button>
                  <button
                    onClick={() => setShowSignUpModal(true)}
                    className="px-2 sm:px-3 py-1.5 rounded-md text-xs sm:text-sm font-semibold transition-all duration-300 bg-gradient-to-r from-green-500 to-cyan-500 text-black hover:shadow-lg hover:shadow-green-500/50 transform hover:scale-105 active:scale-95 whitespace-nowrap"
                  >
                    Sign Up
                  </button>
                </div>
                ...
                {!(vendor || buyer) && (
                  <>
                    <button
                      ...
                      className="w-full px-3 py-2.5 text-sm font-semibold text-center text-green-600 dark:text-green-400 hover:bg-green-500/10 dark:hover:bg-green-500/20 border border-green-500/50 rounded-lg transition"
                    >
                      Sign In
                    </button>
                    <button
                      ...
                      className="w-full px-3 py-2.5 text-sm font-semibold text-center bg-gradient-to-r from-green-500 to-cyan-500 text-black rounded-lg hover:shadow-lg hover:shadow-green-500/50 transition"
                    >
                      Sign Up
                    </button>
                  </>
          ...
          <div className="relative z-10">
            ...
            <div className="mb-6 sm:mb-0 flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold text-green-400 uppercase tracking-widest">MEGA SALE THIS WEEK</span>
              </div>
              ...
              <Link
                ...
                className="sm:hidden inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg bg-gradient-to-r from-green-500 to-cyan-500 text-black font-semibold transition-all duration-300 transform hover:shadow-lg hover:shadow-green-500/50"
              >
            ...
            <div className="hidden sm:flex items-center justify-between gap-4 pt-6 sm:pt-0">
              <div className="text-4xl sm:text-5xl opacity-20">📦</div>
              <Link
                href="/auth/vendor-signup"
                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white dark:bg-zinc-900 text-black dark:text-white font-semibold hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 transform hover:scale-105 active:scale-95 whitespace-nowrap text-sm border-2 border-green-500/50 hover:border-green-500"
              >
